...
const CreateForm = () => {
  ...
  const [backgroundSource, setBackgroundSource] = useState<"custom" | "provided" | null>(null);
  ...
  const handleBackgroundSourceChange = (source: "custom" | "provided" | null) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="pt-6">
            <Button 
              ...
              disabled={!prompt || !backgroundType || !backgroundSource || (backgroundSource === "custom" && !backgroundFile)}
            >
              Create Short
