    ...
    <div className="space-y-4">
      ...
      <div className="space-y-6">
        <input
          ...
          className="w-full h-2 bg-secondary rounded-2xl appearance-none cursor-pointer accent-primary"
        />
        ...
        <div className="flex justify-between">
          {durationOptions.map((duration, index) => (
            <button
              key={duration}
              className={`w-9 h-9 rounded-2xl flex items-center justify-center transition-all text-white ${
                index === value
                  ? "bg-primary"
