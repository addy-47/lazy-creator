...
const Hero = ({
  ...
  return <section className="relative overflow-hidden pt-36 pb-16 md:pt-40 md:pb-24">
      ...
      <div className="container-tight">
        <div className="text-center space-y-8 animate-slide-up [animation-delay:200ms]">
          {username ? <div className="inline-block relative">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 text-sm font-medium text-primary bg-primary/10 rounded-full">
                ...
                Welcome {username}, start your journey of creating effortless YouTube Shorts
              </span>
            ...
            </div> : <div className="inline-block relative">
          ...
          <p className="mx-auto max-w-2xl text-lg text-foreground/70 md:text-xl">
            ...
            No editing skills required. Just select a prompt, customize your options, 
            and let LazyCreator do the rest.
          </p>
