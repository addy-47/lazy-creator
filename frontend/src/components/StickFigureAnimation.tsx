...
const StickFigureAnimation: React.FC<StickFigureAnimationProps> = ({
  ...
  // OPTIMIZATION: Skip animations on low-end devices
  const isMobileOrLowEnd =
    typeof window !== "undefined" &&
    (window.navigator.hardwareConcurrency < 4 || window.innerWidth < 768);

  if (isMobileOrLowEnd) {
    return null; // Don't render on low-end devices
  }
    ...
    <div ref={ref} className={`relative ${className}`}>
      <div
        className={`
          ...
          ${type === "jump" && animated ? "translate-y-0 opacity-1" : ""}
          ...
          {type === "sleep" ? (
            ...
            <>
              ...
              {type === "wave" ? (
                <>
                  <path
                    ...
                    strokeLinecap="round"
                    className={
                      animated ? "animate-[wave_1s_ease-in-out_infinite]" : ""
                    }
                  />
                  <path
                    d="M24 27L30 24"
                ...
                <>
                  <path
                    ...
                    strokeLinecap="round"
                    className={
                      animated ? "animate-[wave_0.7s_ease-in-out_infinite]" : ""
                    }
                  />
                  <path
                    d="M24 27L30 24"
                    ...
                    className={
                      animated
                        ? "animate-[wave_0.7s_ease-in-out_infinite_0.35s]"
                        : ""
                    }
                  />
                </>
                ...
                <>
                  <path
                    ...
                    className={
                      animated
                        ? "animate-[stretch-arm_3s_ease-in-out_infinite]"
                        : ""
                    }
                  />
                  <path
              ...
              <path
                ...
                className={
                  type === "jump" && animated
                    ? "animate-[kick_1s_ease-in-out_infinite]"
                    : type === "dance" && animated
                    ? "animate-[kick_0.7s_ease-in-out_infinite_0.175s]"
                    : ""
                }
              />
              <path
                ...
                className={
                  type === "jump" && animated
                    ? "animate-[kick_1s_ease-in-out_infinite_0.5s]"
                    : type === "dance" && animated
                    ? "animate-[kick_0.7s_ease-in-out_infinite_0.525s]"
                    : ""
                }
              />
